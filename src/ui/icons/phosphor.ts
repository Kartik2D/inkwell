...
export const PHOSPHOR_ICONS: Record<string, string> = {
  ...
  image:
    '<rect x="32" y="48" width="192" height="160" rx="16" opacity="0.2"/><path d="M216,40H40A16,16,0,0,0,24,56V200a16,16,0,0,0,16,16H216a16,16,0,0,0,16-16V56A16,16,0,0,0,216,40Zm0,16V160l-42.34-42.34a8,8,0,0,0-11.32,0L96,200H40V56ZM40,200h44.69l67.31-67.31L184,164.69V200Z"/><circle cx="96" cy="96" r="16"/>',
  "image-plus":
    '<rect x="24" y="48" width="160" height="144" rx="16" opacity="0.2"/><path d="M184,40H40A16,16,0,0,0,24,56V184a16,16,0,0,0,16,16H184a16,16,0,0,0,16-16V56A16,16,0,0,0,184,40Zm0,144H80l56-56,48,48V184Zm0-27.31-36.69-36.69a8,8,0,0,0-11.32,0L80,184H40V56H184ZM240,160v24h24a8,8,0,0,1,0,16H240v24a8,8,0,0,1-16,0V200H200a8,8,0,0,1,0-16h24V160a8,8,0,0,1,16,0Z"/><circle cx="88" cy="96" r="14"/>',
  "speaker-high":
    '<path d="M155.51,24.81a8,8,0,0,0-8.43.88L77.25,80H32A16,16,0,0,0,16,96v64a16,16,0,0,0,16,16H77.25l69.83,54.31A8,8,0,0,0,160,224V32A8,8,0,0,0,155.51,24.81ZM32,96H72v64H32ZM144,207.64,88,164.09V91.91l56-43.55ZM208,128a40,40,0,0,1-12.44,29.11,8,8,0,0,1-11.31-11.31,24,24,0,0,0,0-35.6,8,8,0,1,1,11.31-11.31A40,40,0,0,1,208,128Zm32,0a72.08,72.08,0,0,1-21.13,50.94,8,8,0,0,1-11.32-11.31,56,56,0,0,0,0-79.26,8,8,0,1,1,11.32-11.32A72.08,72.08,0,0,1,240,128Z"/>',
  "speaker-slash":
    '<path d="M53.92,34.62A8,8,0,1,0,42.08,45.38L73.55,80H32A16,16,0,0,0,16,96v64a16,16,0,0,0,16,16H77.25l69.83,54.31A8,8,0,0,0,160,224V166.63l42.08,46.29a8,8,0,1,0,11.84-10.76ZM32,160V96H72v64Zm112,47.64-56-43.55V99.14l56,61.6ZM128,80.54V32a8,8,0,0,1,12.91-6.31L176.54,52.2a8,8,0,1,1-9.72,12.7L144,48.36V63.14ZM227.31,88.2a8,8,0,0,0-11.32,11.32,56,56,0,0,1,0,56.92,8,8,0,0,0,11.32,11.32,72,72,0,0,0,0-79.56Z"/>',
  link:
    '<path d="M117.18,188.74a8,8,0,0,1,0,11.31l-20,20a44,44,0,0,1-62.23-62.22l30.06-30.09a44.07,44.07,0,0,1,62.25,0,8,8,0,1,1-11.32,11.31,28,28,0,0,0-39.6,0L46,157.13a28,28,0,0,0,39.6,39.6l20-20A8,8,0,0,1,117.18,188.74Zm88.87-147.8a44,44,0,0,0-62.23,0l-20,20a8,8,0,0,0,11.31,11.32l20-20a28,28,0,1,1,39.6,39.6l-30.07,30.06a28,28,0,0,1-39.6,0,8,8,0,0,0-11.32,11.32,44,44,0,0,0,62.23,0l30.07-30.06A44,44,0,0,0,206.05,40.94Z"/>',
  magnet:
