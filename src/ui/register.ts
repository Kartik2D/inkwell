...
import "./panels/assist-panel";
import "./panels/settings-panel";
import "./panels/file-panel";
...
export { FlipCelDisclosure } from "./primitives/disclosure";
...
export { FlipCelAssistPanel } from "./panels/assist-panel";
export { FlipCelUniversalPanel } from "./panels/settings-panel";
export { FlipCelFilePanel } from "./panels/file-panel";
...
declare global {
  interface HTMLElementTagNameMap {
    ...
    "flipcel-disclosure": import("./primitives/disclosure").FlipCelDisclosure;
    ...
    "flipcel-file-panel": import("./panels/file-panel").FlipCelFilePanel;
    ...
    "flipcel-assist-panel": import("./panels/assist-panel").FlipCelAssistPanel;
